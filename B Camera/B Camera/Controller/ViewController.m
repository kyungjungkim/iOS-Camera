...
@synthesize activeDevice0, activeDevice1, videoDataOuput, previewLayer, captureSession, expandOrientation, videoDeviceInput,
imageFrameWidth, imageFrameHeight, inProgressPhotoCaptureDelegates, photoQualityPrioritizationMode, inProgressLivePhotoCapturesCount,
spinner, photoBtn, capturePhotoBtn, cameraRotateBtn;

@synthesize cameraView, sessionQueue, checkResult, sessionRunning, videoDeviceDiscoverySession, photoOutput, livePhotoMode,
depthDataDeliveryMode, portraitEffectsMatteDeliveryMode, selectedSemanticSegmentationMatteTypes, deviceTypes, isRotate;
...
- (void)setupVideoDeviceTypes {
    if (@available(iOS 17.0, *)) {
        deviceTypes = [NSArray arrayWithObjects:AVCaptureDeviceTypeBuiltInMicrophone, AVCaptureDeviceTypeBuiltInDualCamera, AVCaptureDeviceTypeBuiltInTripleCamera,
                       ...
                       AVCaptureDeviceTypeBuiltInTrueDepthCamera, AVCaptureDeviceTypeBuiltInTelephotoCamera, AVCaptureDeviceTypeBuiltInLiDARDepthCamera,
                       AVCaptureDeviceTypeContinuityCamera, nil];
    } else {
        deviceTypes = [NSArray arrayWithObjects:AVCaptureDeviceTypeBuiltInMicrophone, AVCaptureDeviceTypeBuiltInDualCamera, AVCaptureDeviceTypeBuiltInTripleCamera,
                       AVCaptureDeviceTypeBuiltInDualWideCamera, AVCaptureDeviceTypeBuiltInUltraWideCamera, AVCaptureDeviceTypeBuiltInWideAngleCamera,
