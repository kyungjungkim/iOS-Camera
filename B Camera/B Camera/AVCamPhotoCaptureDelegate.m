...
- (instancetype)initWithRequestedPhotoSettings:(AVCapturePhotoSettings*)requestedPhotoSettings willCapturePhotoAnimation:(void (^)(void))willCapturePhotoAnimation
                       livePhotoCaptureHandler:(void (^)(BOOL))livePhotoCaptureHandler completionHandler:(void (^)(AVCamPhotoCaptureDelegate*))completionHandler
                        photoProcessingHandler:(void (^)(BOOL))photoProcessingHandler {
    self = [super init];
    if (self) {
...
- (void)handleSemanticSegmentationMatte:(AVSemanticSegmentationMatteType)semanticSegmentationMatteType photo:(AVCapturePhoto *)photo {
    ...
    if (@available(iOS 13.0, *)) {
        if (semanticSegmentationMatteType == AVSemanticSegmentationMatteTypeHair) {
            ...
            if (semanticSegmentationMatteType == AVSemanticSegmentationMatteTypeGlasses) {
    ...
    AVSemanticSegmentationMatte *semanticSegmentationMatte = [[photo semanticSegmentationMatteForType:semanticSegmentationMatteType]
    ...
    NSData *semanticSegmentationData = [context HEIFRepresentationOfImage:semanticSegmetationMatteImage format:kCIFormatRGBA8 colorSpace:linearColorSpace
                                                                  options:@{(id)kCIImageRepresentationPortraitEffectsMatteImage : semanticSegmetationMatteImage} ];
...
- (void) captureOutput:(AVCapturePhotoOutput *)captureOutput didFinishRecordingLivePhotoMovieForEventualFileAtURL:(NSURL *)outputFileURL
